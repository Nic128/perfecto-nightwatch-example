var downloadReport = require('../utils/downloadReport');
...
module.exports = {
  ...
  'Demo test Google' : function (client) {
    ...
    client.expect.element('body').to.have.attribute('class').which.contains('hp');
    client.expect.element('body').to.have.attribute('class').which.matches(/hp$/);
